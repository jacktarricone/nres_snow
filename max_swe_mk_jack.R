...
# save
writeRaster(p_value,"/Volumes/jt/projects/margulis/snow_metric_rasters/max_swe/mk_results/max_swe_p_value.tif")
writeRaster(slope, "/Volumes/jt/projects/margulis/snow_metric_rasters/max_swe/mk_results/max_swe_slope.tif")
