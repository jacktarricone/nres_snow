...
# download 1 WY of gridmet data (palmer)
...
setwd(file.path("/Volumes","jack_t","nres_project","gridmet_data","palmer")) 

# create file name with year
hdf_file_name <-paste0("palmer_daily_wy_",wy,".h5")
...
h5createDataset(file = hdf_file_name, dataset = "palmer",
...
system.time(h5write(climate_array, hdf_file_name,"palmer"))
